...
func NewCA(
	...
	sm2Tpl.PublicKey = sm2PubKey
	x509Cert, err := genCertificateGMSM2(
		baseDir,
		name,
		sm2Tpl,
		sm2Tpl,
...
func genCertificateGMSM2(baseDir, name string, template, parent *sm2.Certificate, pub *sm2.PublicKey, key bccsp.Key) (*sm2.Certificate, error) {
